...
from app.gis.geojson import Cafe, coordinate, unique_cafes


def sql_file(name: str) -> str:
    return files("app").joinpath("sql", name).read_text(encoding="utf-8")


def init_db(dsn: str) -> None:
    with connect(dsn) as connection:
        connection.execute(sql_file("001_schema.sql"))
